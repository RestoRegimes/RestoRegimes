...
class ap_DevDebugProjectContainer extends Container
{
    ...
    protected function getBazingaGeocoder_GeocoderService()
    {
        ...
        $instance->registerProviders(array());
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $c->addDriver($b, 'RR\\RestaurantBundle\\Entity');
        $c->addDriver($b, 'RR\\UserBundle\\Entity');
        $c->addDriver($b, 'Padam87\\AddressBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('RRRestaurantBundle' => 'RR\\RestaurantBundle\\Entity', 'RRUserBundle' => 'RR\\UserBundle\\Entity', 'Padam87AddressBundle' => 'Padam87\\AddressBundle\\Entity'));
