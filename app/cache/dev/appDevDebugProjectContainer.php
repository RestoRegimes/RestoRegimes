...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/pro/');
        ...
        $o->add($m, array(0 => 'ROLE_PRO'), NULL);
        $o->add($n, array(0 => 'ROLE_USER'), NULL);

        $p = new \Symfony\Component\Security\Http\HttpUtils($e, $e);

        $q = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), '2b34770401aea22ced93ce7602c3a5cbe69e18fe', 'main', array('name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('noreply.resto@gmail.com');
        $a->setPassword('restoregime');
        $a->setAuthMode('login');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'GregwarCaptchaBundle::captcha.html.twig', 1 => 'form_div_layout.html.twig', 2 => 'VichUploaderBundle:Form:fields.html.twig', 3 => 'IvoryGoogleMapBundle:Form:places_autocomplete_widget.html.twig')), $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_PRO'), 'ROLE_PRO' => array(0 => 'ROLE_USER')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_host' => NULL,
            'mailer_user' => 'noreply.resto@gmail.com',
            'mailer_password' => 'restoregime',
            ...
            'twig.form.resources' => array(
                ...
                3 => 'IvoryGoogleMapBundle:Form:places_autocomplete_widget.html.twig',
            ),
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'noreply.resto@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'restoregime',
